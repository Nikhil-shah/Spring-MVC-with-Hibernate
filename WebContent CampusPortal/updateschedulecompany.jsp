		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<li><a href="${pageContext.request.contextPath}/addcompany1">Company</a></li>
					<li class="active"><a href="${pageContext.request.contextPath}/scheduleforcompany">Schedule Company</a></li>
			...
			<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<form:form action="registerschedulecompany" modelAttribute="command">
							...
							<div class="top-margin">
								...
								<form:select path="name" class="form-control">
									<c:forEach var="company1" items="${command.companyList}">
    									...
    									<form:option value="${company1.companyid}">${company1.name}</form:option>
									</c:forEach>
								</form:select>
							</div>
