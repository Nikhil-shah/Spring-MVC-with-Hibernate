		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					<li class="active"><a href="${pageContext.request.contextPath}/home/${sessionScope.login.course}">Applicable Companies</a></li>
			  ...
			  <tbody style="width:10%;">
			  	<c:forEach var="company" items="${command.companyList}">
					...
					<tr>
					 ...
					 <spring:url value="/showapplyforcompany/${company.name}" var="applyurl" />
						<td align="right" colspan="2"><button onclick="location.href='${applyurl}'" class="btn btn-action" type="submit">Apply</button></td>
