	...
	<div class="row">
		...
		<article class="col-md-8 maincontent">
			<header class="page-header">
				<h1 class="page-title">Applied Companies</h1>
			</header>
			<div class="table-responsive">
		   <table class="table" >
			  <tbody style="width:10%;">
			  	<c:forEach var="company" items="${command.appliedCompanies}">
			  	
					<tr >
						<td colspan="2"><h3><b><a href="${pageContext.request.contextPath}/home/companydetails/${company.name}">${company.name}</a></b></h3></td>
