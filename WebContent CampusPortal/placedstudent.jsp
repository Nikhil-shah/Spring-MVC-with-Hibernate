		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="active"><a href="showaboutrecruiters">Recruiters</a></li>
					<!--  <li class="dropdown">
	...
	<div class="row">
		...
		<!-- Article main content -->
			...
			<header class="page-header">
				...
				<h1 class="page-title">Placed Student</h1>
			</header>
		   ...
		   <table class="table">
			  ...
			  <tbody>
			  	<c:forEach var="student" items="${command.placedStudentsList}">
					<tr>
						<td>${student.srno}</td>
						<td>${student.name}</td>
						<td>${student.companyname}</td>
						<td>${student.gspackage}</td>
					 </tr>
				 </c:forEach>
			  </tbody>
		   </table>
